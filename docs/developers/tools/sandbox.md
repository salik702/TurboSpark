...
#### 1、Clone turbospark project first, https://github.com/turbospark/turbospark.git
...
# 2. Build the TURBO SPARK project
npm run build
...
ls -la $(dirname $(which qwen))/../lib/node_modules/@turbospark/turbospark
...
- Path: `.turbospark/sandbox.Dockerfile`

- Official mirror image address:https://github.com/turbospark/turbospark/pkgs/container/turbospark

```bash
# Based on the official Qwen sandbox image (It is recommended to explicitly specify the version)
FROM ghcr.io/turbospark/turbospark:sha-570ec43
...
npm unlink -g @turbospark/turbospark
