...
This document describes the `exit_plan_mode` tool for TURBO SPARK.
...
## How to use `exit_plan_mode` with TURBO SPARK

The Exit Plan Mode tool is part of TURBO SPARK's planning workflow. When you're in plan mode (typically after exploring a codebase and designing an implementation approach), you use this tool to:
