...
- Node.js >= 22.0.0
- [TURBO SPARK](https://github.com/turbospark/turbospark) >= 0.4.0 (stable) installed and accessible in PATH

> **Note for nvm users**: If you use nvm to manage Node.js versions, the SDK may not be able to auto-detect the TURBO SPARK executable. You should explicitly set the `pathToTurbosparkExecutable` option to the full path of the `qwen` binary.
