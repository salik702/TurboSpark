export default {
  ...
  'qwen-serve': 'Daemon mode (turbospark serve)',
  'turbospark-serve-deploy-local': 'Daemon mode — local launch templates',
  'Code with TURBO SPARK': {
    type: 'separator',
    title: 'Code with TURBO SPARK', // Title is optional
  },
  features: 'Features',
