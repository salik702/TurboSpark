...
This guide covers setting up a TURBO SPARK channel on WeChat via the official iLink Bot API.
...
This will display a QR code URL. Scan it with your WeChat mobile app to authenticate. Your credentials are saved to `~/.turbospark/channels/weixin/account.json`.

### 2. Configure the channel

Add the channel to `~/.turbospark/settings.json`:
