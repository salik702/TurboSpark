...
This document details all commands supported by TURBO SPARK, helping you efficiently manage sessions, customize the interface, and control its behavior.

TURBO SPARK commands are triggered through specific prefixes and fall into three categories:

| Prefix Type                | Function Description                                | Typical Use Case                                                 |
| -------------------------- | --------------------------------------------------- | ---------------------------------------------------------------- |
| Slash Commands (`/`)       | Meta-level control of TURBO SPARK itself              | Managing sessions, modifying settings, getting help              |
...
Slash commands are used to manage TURBO SPARK sessions, interface, and basic behavior.
...
| `/hooks`         | Manage TURBO SPARK hooks                        | `/hooks`, `/hooks list`                       |
...
| `/qc-helper` | Answer questions about TURBO SPARK usage and configuration            | `/qc-helper how do I configure MCP?`              |
...
| `/docs`         | Open full TURBO SPARK documentation in browser                                                                                                                                                                                                                                                    | `/docs`                          |
...
| `/bug`          | Submit issue about TURBO SPARK                                                                                                                                                                                                                                                                    | `/bug Button click unresponsive` |
...
Use `/auth` inside a TURBO SPARK session to configure authentication. Use `/doctor` to inspect the current authentication and environment status.
...
Exclamation commands allow you to execute system commands directly within TURBO SPARK.
...
| Global Commands  | `~/.turbospark/commands/`                        | Available in all projects              | Low      | Personal frequently used commands, cross-project use |
| Project Commands | `<project root directory>/.turbospark/commands/` | Project-specific, version-controllable | High     | Team sharing, project-specific commands              |
...
| ---------------------------------------- | ----------------- | --------------------- |
| `~/.turbospark/commands/test.md`               | `/test`           | `/test Parameter`     |
| `<project>/.turbospark/commands/git/commit.md` | `/git:commit`     | `/git:commit Message` |
...
| ----------------------------- | ----------------------------------------- |
| 1. Create directory structure | `mkdir -p ~/.turbospark/commands/refactor`      |
| 2. Create command file        | `touch ~/.turbospark/commands/refactor/pure.md` |
...
Lists your recent TURBO SPARK sessions with metadata.
