...
describe('Configuration Options (E2E)', () => {
  ...
  describe('authType Option', () => {
    ...
    // Skip - turbospark-oauth requires user interaction which is not possible in CI environments
    it.skip('should accept authType: turbospark-oauth', async () => {
      // Note: turbospark-oauth requires credentials in ~/.turbospark and user interaction
