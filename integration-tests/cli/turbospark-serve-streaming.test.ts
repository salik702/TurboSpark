...
/**
 * `turbospark serve` daemon — streaming / multi-client / recovery integration.
 *
...
import { DaemonClient, parseSseStream } from '@turbospark/sdk';
import type { DaemonEvent, DaemonSessionSummary } from '@turbospark/sdk';
...
// note in turbospark-serve-routes.test.ts for full rationale.
const CLI_BIN =
...
describeLLM('turbospark serve — child-crash recovery (real SIGKILL)', () => {
...
describeLLM('turbospark serve — multi-client first-responder permission', () => {
...
describeLLM('turbospark serve — Last-Event-ID resume', () => {
