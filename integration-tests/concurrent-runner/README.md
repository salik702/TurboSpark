...
```json
{
  ...
  "yolo": true,
  "source_repo": ".",
  "worktree_base": "~/.turbospark/worktrees",
  "outputs_dir": "./outputs",
...
| `worktree_base` | string | ~/.turbospark/worktrees | Base directory for git worktrees              |
  ...
  "runs": [
    {
      ...
      "status": "succeeded",
      "worktree_path": "~/.turbospark/worktrees/run-abc123",
