 ...
 *
 * Tests the actual MockPluginChannel (from @turbospark/channel-plugin-example) connected
 ...
 *           → turbospark --acp (REAL model request)
...
describe('Channel Plugin (Mock WebSocket E2E)', () => {
  ...
  const setup = async () => {
    ...
    // 2. Start AcpBridge (spawns real turbospark --acp)
