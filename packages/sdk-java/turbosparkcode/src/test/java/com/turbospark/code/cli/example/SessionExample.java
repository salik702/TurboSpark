package com.turbospark.code.cli.example;

import com.alibaba.fastjson2.JSON;
import com.turbospark.code.cli.TurbosparkCli;
...
import com.turbospark.code.cli.protocol.data.behavior.Behavior.Operation;
...
import com.turbospark.code.cli.session.event.consumers.AssistantContentSimpleConsumers;
import com.turbospark.code.cli.session.event.consumers.SessionEventSimpleConsumers;
...
import com.turbospark.code.cli.protocol.message.assistant.block.TextBlock;
...
public class SessionExample {
    ...
    public static void main(String[] args) {
        Session session = TurbosparkCli.newSession();
        try {
