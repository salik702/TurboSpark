package com.turbospark.code.cli.session;
...
import com.turbospark.code.cli.protocol.data.Capabilities;
import com.turbospark.code.cli.protocol.data.PermissionMode;
import com.turbospark.code.cli.protocol.message.SDKResultMessage;
import com.turbospark.code.cli.protocol.message.SDKSystemMessage;
import com.turbospark.code.cli.protocol.message.SDKUserMessage;
import com.turbospark.code.cli.protocol.message.assistant.SDKAssistantMessage;
import com.turbospark.code.cli.protocol.message.assistant.SDKPartialAssistantMessage;
import com.turbospark.code.cli.protocol.message.control.payload.CLIControlInitializeRequest;
import com.turbospark.code.cli.protocol.message.control.payload.CLIControlInitializeResponse;
import com.turbospark.code.cli.protocol.message.control.payload.CLIControlInterruptRequest;
import com.turbospark.code.cli.protocol.message.control.CLIControlRequest;
import com.turbospark.code.cli.protocol.message.control.CLIControlResponse;
import com.turbospark.code.cli.protocol.message.control.payload.CLIControlSetModelRequest;
import com.turbospark.code.cli.protocol.message.control.payload.CLIControlSetPermissionModeRequest;
import com.turbospark.code.cli.protocol.message.control.payload.ControlRequestPayload;
import com.turbospark.code.cli.protocol.message.control.payload.ControlResponsePayload;
import com.turbospark.code.cli.session.event.consumers.SessionEventConsumers;
import com.turbospark.code.cli.session.exception.SessionControlException;
import com.turbospark.code.cli.session.exception.SessionSendPromptException;
import com.turbospark.code.cli.transport.Transport;
import com.turbospark.code.cli.transport.TransportOptions;
import com.turbospark.code.cli.utils.MyConcurrentUtils;
import com.turbospark.code.cli.utils.Timeout;
...
/**
 * Manages a session with the TURBOSPARK CLI, handling communication, sending prompts, and processing responses.
 *
 * @author skyfire
 * @version $Id: 0.0.1
 */
public class Session {
     ...
     * @throws com.turbospark.code.cli.session.exception.SessionControlException if the transport is not available
     */
     ...
     *
     * @throws com.turbospark.code.cli.session.exception.SessionControlException if initialization fails
     */
     ...
     *
     * @throws com.turbospark.code.cli.session.exception.SessionControlException if closing fails
     */
     ...
     * @throws com.turbospark.code.cli.session.exception.SessionControlException if the operation fails
     */
     ...
     * @throws com.turbospark.code.cli.session.exception.SessionSendPromptException if sending the prompt fails
     * @throws com.turbospark.code.cli.session.exception.SessionControlException if a control operation fails
     */
