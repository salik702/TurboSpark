...
import com.turbospark.code.cli.session.event.consumers.AssistantContentConsumers;
...
import com.turbospark.code.cli.transport.process.ProcessTransport;
...
/**
 * Main entry point for interacting with the TURBOSPARK CLI. Provides static methods for simple queries and session management.
 *
 * @author skyfire
 * @version $Id: 0.0.1
 */
public class TurbosparkCli {
    private static final Logger log = LoggerFactory.getLogger(TurbosparkCli.class);

    /**
     * Sends a simple query to the TURBOSPARK CLI and returns a list of responses.
     *
