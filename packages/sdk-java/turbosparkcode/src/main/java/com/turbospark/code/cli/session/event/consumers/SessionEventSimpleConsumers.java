package com.turbospark.code.cli.session.event.consumers;

import java.util.List;
import java.util.Optional;

import com.turbospark.code.cli.protocol.data.AssistantContent;
import com.turbospark.code.cli.protocol.data.AssistantContent.TextAssistantContent;
import com.turbospark.code.cli.protocol.data.AssistantContent.ThinkingAssistantContent;
import com.turbospark.code.cli.protocol.data.AssistantContent.ToolResultAssistantContent;
import com.turbospark.code.cli.protocol.data.AssistantContent.ToolUseAssistantContent;
import com.turbospark.code.cli.protocol.data.AssistantUsage;
import com.turbospark.code.cli.protocol.data.behavior.Allow;
import com.turbospark.code.cli.protocol.data.behavior.Behavior;
...
import com.turbospark.code.cli.protocol.message.assistant.block.ContentBlock;
import com.turbospark.code.cli.protocol.message.assistant.event.ContentBlockDeltaEvent;
import com.turbospark.code.cli.protocol.message.assistant.event.StreamEvent;
import com.turbospark.code.cli.protocol.message.control.payload.CLIControlPermissionRequest;
import com.turbospark.code.cli.protocol.message.control.payload.CLIControlPermissionResponse;
...
import com.turbospark.code.cli.session.Session;
...
public class SessionEventSimpleConsumers implements SessionEventConsumers {
     ...
     *
     * @param session a {@link com.turbospark.code.cli.session.Session} object.
     * @param assistantContent a {@link com.turbospark.code.cli.protocol.data.AssistantContent} object.
     */
