...
This release includes updates to the TURBO SPARK Java SDK with improved session management, enhanced transport options, and better error handling capabilities.
...
```gradle
implementation 'com.alibaba:turbosparkcode-sdk:0.0.1-alpha'
```
...
3. **Extended API Coverage**: More comprehensive coverage of TURBO SPARK CLI features
...
- Issue Tracker: https://github.com/turbospark/turbospark/issues
