...
<dependency>
    ...
    <artifactId>turbosparkcode-sdk</artifactId>
...
```gradle
implementation 'com.alibaba:turbosparkcode-sdk:{$version}'
```
...
The simplest way to use the SDK is through the `TurbosparkCli.simpleQuery()` method:
...
public static void runTransportOptionsExample() {
    ...
    List<String> result = TurbosparkCli.simpleQuery("who are you, what are your capabilities?", options);
    result.forEach(logger::info);
}
```
...
public static void runStreamingExample() {
    TurbosparkCli.simpleQuery("who are you, what are your capabilities?",
...
other examples see src/test/java/com/alibaba/turbospark/code/cli/example
