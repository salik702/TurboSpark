...
import com.turbospark.acp.sdk.protocol.domain.agent.AgentCapabilities;
import com.turbospark.acp.sdk.protocol.domain.agent.AgentInfo;
import com.turbospark.acp.sdk.protocol.domain.agent.AuthMethod;
import com.turbospark.acp.sdk.protocol.jsonrpc.Response;

import static com.turbospark.acp.sdk.protocol.agent.response.InitializeResponse.InitializeResponseResult;
