...
import com.turbospark.acp.sdk.protocol.client.response.terminal.CreateTerminalResponse.CreateTerminalResponseResult;
import com.turbospark.acp.sdk.protocol.client.response.terminal.KillTerminalCommandResponse.KillTerminalCommandResponseResult;
import com.turbospark.acp.sdk.protocol.client.response.terminal.ReleaseTerminalResponse.ReleaseTerminalResponseResult;
import com.turbospark.acp.sdk.protocol.client.response.terminal.TerminalOutputResponse.TerminalOutputResponseResult;
import com.turbospark.acp.sdk.protocol.client.response.terminal.WaitForTerminalExitResponse.WaitForTerminalExitResponseResult;
