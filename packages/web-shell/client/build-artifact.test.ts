...
describe('build artifact — package boundary', () => {
  it('externalizes @turbospark/webui/daemon-react-sdk', () => {
    const bundle = readBundle();
    expect(bundle).toContain('from "@turbospark/webui/daemon-react-sdk"');
  });
  ...
  it('externalizes @turbospark/sdk subpaths', () => {
    const bundle = readBundle();
