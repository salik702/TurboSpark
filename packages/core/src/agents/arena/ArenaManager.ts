...
export class ArenaManager {
  ...
  constructor(config: Config, callbacks: ArenaCallbacks = {}) {
    ...
    // Use the user-configured base dir, or default to ~/.turbospark/arena.
    this.arenaBaseDir =
      arenaSettings?.worktreeBaseDir ??
      path.join(Storage.getGlobalTurbosparkDir(), 'arena');
   ...
   * `~/.turbospark/worktrees/<sessionId>/`.  The directory contains:
