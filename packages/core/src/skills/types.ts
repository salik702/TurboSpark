 ...
 * - 'project': Stored in `.turbospark/skills/` within the project directory
 * - 'user': Stored in `~/.turbospark/skills/` in the user's home directory
 * - 'extension': Provided by an installed extension
 * - 'bundled': Built-in skills shipped with turbospark
 */
...
export interface SkillConfig {
   ...
   * `fast`, bare model ID (e.g., `turbosparkr-plus`),
