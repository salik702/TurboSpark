...
export {
  ...
  TURBOSPARK_OAUTH_MODELS,
  TURBOSPARK_OAUTH_MODELS as QWEN_OAUTH_MODELS,
  resolveModelConfig,
...
// module path (e.g. `@turbospark/turbospark-core/dist/tools/edit.js`) as these
...
// re-exported so the `turbospark serve` daemon can mutate workspace memory
...
export { TurbosparkLogger } from './telemetry/turbospark-logger/turbospark-logger.js';
...
export * from './turbospark/turbosparkOAuth2.js';
