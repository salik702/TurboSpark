...
describe('FileSearch', () => {
  ...
  it('should use .turbosparkignore rules', async () => {
    tmpDir = await createTmpDir({
      '.turbosparkignore': 'dist/',
      dist: ['ignored.js'],
      src: ['not-ignored.js'],
    });
    ...
    expect(results).toEqual(['src/', '.turbosparkignore', 'src/not-ignored.js']);
  });

  it('should combine .gitignore and .turbosparkignore rules', async () => {
    tmpDir = await createTmpDir({
      '.gitignore': 'dist/',
      '.turbosparkignore': 'build/',
