...
export const SHELL_SELF_KILL_REJECTION =
  'Blocked: this command may terminate the running turbospark process because it targets all node/turbospark processes. Use task_stop for managed background shells, or kill a specific PID instead.';
