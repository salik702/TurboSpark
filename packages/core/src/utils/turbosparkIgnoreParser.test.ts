...
import { TurbosparkIgnoreParser } from './turbosparkIgnoreParser.js';
import * as fs from 'node:fs/promises';
import * as path from 'node:path';
import * as os from 'node:os';

describe('TurbosparkIgnoreParser', () => {
  ...
  describe('when .turbosparkignore exists', () => {
    beforeEach(async () => {
    ...
    it('should ignore files specified in .turbosparkignore', () => {
      const parser = new TurbosparkIgnoreParser(projectRoot);
  ...
  describe('when .turbosparkignore does not exist', () => {
