...
export function parseAndFormatApiError(
  ...
  if (isStructuredError(error)) {
    // TURBOSPARK OAuth quota errors have their own user-friendly message; don't wrap them
    if (
      error.message.startsWith('TURBOSPARK OAuth quota exceeded:') ||
      error.message.startsWith('TURBOSPARK OAuth free tier has been discontinued')
    ) {
