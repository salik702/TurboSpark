      ...
      if (entry.isFile()) {
        ...
        if (options.fileService) {
          const shouldIgnore =
            ...
            (options.fileFilteringOptions.respectTurbosparkIgnore &&
              options.fileService.shouldTurbosparkIgnoreFile(filePath));
          if (shouldIgnore) {
            continue;
          }
        }
      ...
      if (entry.isDirectory()) {
        ...
        if (options.fileService) {
          isIgnored =
            ...
            (options.fileFilteringOptions.respectTurbosparkIgnore &&
              options.fileService.shouldTurbosparkIgnoreFile(subFolderPath));
        }
