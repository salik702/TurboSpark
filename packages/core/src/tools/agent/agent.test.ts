...
describe('AgentTool', () => {
  ...
  const mockSubagents: SubagentConfig[] = [
    {
      ...
      level: 'project',
      filePath: '/project/.turbospark/agents/file-search.md',
    },
    {
      name: 'code-review',
      ...
      level: 'user',
      filePath: '/home/user/.turbospark/agents/code-review.md',
    },
  ];
  ...
  beforeEach(async () => {
    ...
    config = {
      ...
      storage: {
        getProjectDir: vi.fn().mockReturnValue('/test/project/.turbospark'),
      },
      ...
      const newSubagents: SubagentConfig[] = [
        {
          ...
          level: 'project',
          filePath: '/project/.turbospark/agents/new-agent.md',
        },
      ];
      ...
      const newSubagents: SubagentConfig[] = [
        {
          ...
          level: 'project',
          filePath: '/project/.turbospark/agents/test-agent.md',
        },
      ];
  ...
  describe('AgentToolInvocation', () => {
    ...
    describe('turbospark.subagent span outcome (#4410 wenshao)', () => {
      beforeEach(() => {
  ...
  describe('Agent-level background: true', () => {
    ...
    const bgSubagent: SubagentConfig = {
      ...
      level: 'project',
      filePath: '/project/.turbospark/agents/monitor.md',
      background: true,
    };
