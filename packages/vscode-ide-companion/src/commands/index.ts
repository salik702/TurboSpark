...
export const runTurbosparkCodeCommand = 'turbospark.runTurbosparkCode';
export const showDiffCommand = 'qwenCode.showDiff';
export const openChatCommand = 'turbospark.openChat';
export const openNewChatTabCommand = 'qwenCode.openNewChatTab';
export const authCommand = 'turbospark.auth';
export const focusChatCommand = 'turbospark.focusChat';
export const newConversationCommand = 'turbospark.newConversation';
export const showLogsCommand = 'turbospark.showLogs';

/**
 * Register all TURBO SPARK chat-related commands.
 *
    ...
    vscode.commands.registerCommand(showLogsCommand, async () => {
      if (outputChannel) {
        ...
        vscode.window.showWarningMessage(
          'TURBO SPARK Companion log channel is not available.',
        );
      }
    }),
  );
