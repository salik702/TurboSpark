...
export class DiffManager {
  ...
  async showDiff(filePath: string, a: string, b?: string): Promise<void> {
    ...
    // Left side: old content using turbospark-diff scheme
    ...
    // Right side: new content using turbospark-diff scheme
  ...
  /** Close all open turbospark-diff editors */
