...
// Value matches AuthType.USE_OPENAI from @turbospark/turbospark-core.
...
export interface SessionUpdateMeta {
  ...
  source?: string | null;
  turbosparkDiscreteMessage?: boolean | null;
  ...
  // same turbosparkDiscreteMessage flag) and avoid persisting both.
