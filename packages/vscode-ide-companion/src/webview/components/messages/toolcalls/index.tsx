 ...
 * All UI components are now imported from @turbospark/webui
 */

import { shouldShowToolCall, getToolCallComponent } from '@turbospark/webui';
import type { FC } from 'react';
import type { BaseToolCallProps } from '@turbospark/webui';
...
export type { BaseToolCallProps, ToolCallData } from '@turbospark/webui';
