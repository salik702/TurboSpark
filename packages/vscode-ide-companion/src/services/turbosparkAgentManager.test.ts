...
} from './turbosparkAgentManager.js';
...
describe('TurbosparkAgentManager.setModelFromUi', () => {
  it('emits the selected model metadata from the available models list', async () => {
    const manager = new TurbosparkAgentManager();
...
describe('TurbosparkAgentManager.createNewSession', () => {
