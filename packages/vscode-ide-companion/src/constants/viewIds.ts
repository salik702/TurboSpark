 ...
 * `turbospark:supportsSecondarySidebar` context key in package.json.
 ...
 */
export const CHAT_VIEW_ID_SIDEBAR = 'turbospark.chatView.sidebar';
export const CHAT_VIEW_ID_SECONDARY = 'turbospark.chatView.secondary';
