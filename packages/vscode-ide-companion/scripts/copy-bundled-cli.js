...
/**
 * Copy the already-built root dist/ folder into the extension dist/turbospark-cli/.
 *
...
const bundledCliDir = path.join(extensionDistDir, 'turbospark-cli');
...
async function main() {
  ...
  const tmpNodeModules = path.join(
    extensionDistDir,
    'turbospark-cli.node_modules.tmp',
  );
