...
import { AuthType, type Config } from '@turbospark/turbospark-core';
...
describe('availableModels', () => {
  ...
  describe('getAvailableModelsForAuthType', () => {
    ...
    it('should return hard-coded qwen models for turbospark-oauth', () => {
    ...
    it('should use config models for turbospark-oauth when config is provided', () => {
      const mockConfig = {
