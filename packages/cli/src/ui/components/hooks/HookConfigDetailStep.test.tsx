...
describe('HookConfigDetailStep', () => {
  const createMockHookEvent = (): HookEventDisplayInfo => ({
    ...
    shortDescription: 'Right before TURBO SPARK concludes its response',
    description: '',
    exitCodes: [
  ...
  it('should render source for Extensions with path', () => {
    ...
    const hookConfig = createMockHookConfig(
      ...
      'ralph-wiggum',
      '/Users/test/.turbospark/extensions/ralph-wiggum',
    );
    ...
    expect(lastFrame()).toContain('/Users/test/.turbospark/extensions/ralph-wiggum');
  });
