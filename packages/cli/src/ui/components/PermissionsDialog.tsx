...
import { isPathWithinRoot, parseRule } from '@turbospark/turbospark-core';
  ...
  return [
    {
      ...
      description: t('Checked in at .turbospark/settings.json'),
      value: SettingScope.Workspace,
      key: 'project',
    },
    {
      label: t('User settings'),
      description: t('Saved in at ~/.turbospark/settings.json'),
  ...
  return [
    {
      id: 'allow',
      label: t('Allow'),
      description: t("TURBO SPARK won't ask before using allowed tools."),
    },
    {
      id: 'ask',
      label: t('Ask'),
      description: t('TURBO SPARK will ask before using these tools.'),
    },
    {
      id: 'deny',
      label: t('Deny'),
      description: t('TURBO SPARK is not allowed to use denied tools.'),
    },
    {
      id: 'workspace',
      label: t('Workspace'),
