...
import { useTurbosparkAuth } from '../hooks/useTurbosparkAuth.js';
...
export type { TurbosparkAuthState } from '../hooks/useTurbosparkAuth.js';
...
export type AuthUiState = {
  ...
  qwenAuthState: ReturnType<typeof useTurbosparkAuth>['qwenAuthState'];
  turbosparkAuthState: ReturnType<typeof useTurbosparkAuth>['qwenAuthState'];
};
...
export const useAuthCommand = (
  ...
  const { qwenAuthState, cancelTurbosparkAuth } = useTurbosparkAuth(
    pendingAuthType,
    isAuthenticating,
  );
  ...
  const cancelAuthentication = useCallback(() => {
    ...
    setIsAuthDialogOpen(true);
    setAuthError(null);
  }, [isAuthenticating, pendingAuthType, cancelTurbosparkAuth, config]);
