...
const qwenLightColors: ColorsTheme = {
  ...
  Background: '#f8f9fa',
  Foreground: '#3a3a3a',
  LightBlue: '#CC5500',       // Burnt Orange
  AccentBlue: '#E63000',      // Red-Orange
  AccentPurple: '#FF6600',    // Orange
  AccentCyan: '#D44000',      // Dark Red-Orange
  AccentGreen: '#86b300',
  AccentYellow: '#E07B00',
  AccentRed: '#CC0000',
  ...
  Comment: '#ABADB1',
  Gray: '#CCCFD3',
  GradientColors: ['#C0392B', '#E67E22', '#F39C12'],
};
