...
// Chinese translations for TURBO SPARK CLI
...
export default {
  ...
  'for help on TURBO SPARK': '获取 TURBO SPARK 帮助',
  ...
  'Workspace is untrusted; workspace settings are ignored by the merged config. Run /trust first to persist skills changes here, or edit ~/.turbospark/settings.json directly to manage skills at user scope.':
    '当前工作区未受信任，工作区设置会被合并配置忽略。请先执行 /trust，或直接编辑 ~/.turbospark/settings.json 在用户范围管理技能。',
  ...
  'All available skills are disabled. Edit ~/.turbospark/settings.json or .turbospark/settings.json (skills.disabled) to re-enable.':
    '所有可用技能均已禁用。请编辑 ~/.turbospark/settings.json 或 .turbospark/settings.json（skills.disabled）以重新启用。',
  ...
  // ============================================================================
  'Project Level (.turbospark/agents/)': '项目级 (.turbospark/agents/)',
  'User Level (~/.turbospark/agents/)': '用户级 (~/.turbospark/agents/)',
  ...
  'Generate with TURBO SPARK (Recommended)': '使用 TURBO SPARK 生成（推荐）',
  ...
  // ============================================================================
  'View and edit TURBO SPARK settings': '查看和编辑 TURBO SPARK 设置',
  Settings: '设置',
  'To see changes, TURBO SPARK must be restarted. Press r to exit and apply changes now.':
    '要查看更改，必须重启 TURBO SPARK。按 r 退出并立即应用更改。',
  // ============================================================================
  // Settings Labels
  // ============================================================================
  'Vim Mode': 'Vim 模式',
  ...
  'This extension will append info to your TURBOSPARK.md context using {{fileName}}':
    '此扩展将使用 {{fileName}} 向您的 TURBOSPARK.md 上下文追加信息',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with TURBO SPARK.':
    '您正在安装来自 {{originSource}} 的扩展。某些功能可能无法完美兼容 TURBO SPARK。',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run TURBO SPARK in one of these supported IDEs: VS Code or VS Code forks.':
    '您当前环境不支持 IDE 集成。要使用此功能，请在以下支持的 IDE 之一中运行 TURBO SPARK：VS Code 或 VS Code 分支版本。',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask TURBO SPARK.':
    '此菜单为只读。要添加或修改 Hook，请直接编辑 settings.json 或询问 TURBO SPARK。',
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask TURBO SPARK.':
    '要重新启用 Hook，请从 settings.json 中删除 "disableAllHooks" 或询问 TURBO SPARK。',
  // Hooks - Source
  Project: '项目',
  User: '用户',
  Skill: '技能',
  ...
  'Right before TURBO SPARK concludes its response': 'TURBO SPARK 结束响应之前',
  ...
  'Generate a project summary and save it to .turbospark/PROJECT_SUMMARY.md':
    '生成项目摘要并保存到 .turbospark/PROJECT_SUMMARY.md',
  ...
  'Successfully added TURBOSPARK.md files from the following directories if there are:\n- {{directories}}':
    '如果存在，已成功从以下目录添加 TURBOSPARK.md 文件：\n- {{directories}}',
  ...
  'TURBOSPARK OAuth': 'TURBOSPARK OAuth (免费)',
  ...
  'TURBOSPARK OAuth free tier was discontinued on 2026-04-15. Please select Coding Plan or API Key instead.':
    'TURBOSPARK OAuth 免费额度已于 2026-04-15 停用。请选择 Coding Plan 或 API Key。',
  'TURBOSPARK OAuth free tier was discontinued on 2026-04-15. Please select a model from another provider or run /auth to switch.':
    'TURBOSPARK OAuth免费层已于2026-04-15停止服务。请选择其他提供商的模型或运行 /auth 切换。',
  '\n⚠ TURBOSPARK OAuth free tier was discontinued on 2026-04-15. Please select another option.\n':
    '\n⚠ TURBOSPARK OAuth 免费额度已于 2026-04-15 停用。请选择其他选项。\n',
  ...
  'TURBOSPARK OAuth Authentication': 'TURBOSPARK OAuth 认证',
  'Please visit this URL to authorize:': '请访问此 URL 进行授权：',
  'Waiting for authorization': '等待授权中',
  'Time remaining:': '剩余时间：',
  'TURBOSPARK OAuth Authentication Timeout': 'TURBOSPARK OAuth 认证超时',
  'OAuth token expired (over {{seconds}} seconds). Please select authentication method again.':
    'OAuth token 已过期（超过 {{seconds}} 秒）。请重新选择认证方法',
  'Press any key to return to authentication type selection.':
    '按任意键返回认证类型选择',
  'Waiting for TURBOSPARK OAuth authentication...': '正在等待 TURBOSPARK OAuth 认证...',
  ...
  'You can run any shell commands from TURBO SPARK using ! (e.g. !ls).':
    '在 TURBO SPARK 中使用 ! 可运行任意 shell 命令（例如 !ls）。',
  ...
  // Exit Screen / Stats
  // ============================================================================
  'Agent powering down. Goodbye!': 'TURBO SPARK 正在关闭，再见！',
  ...
  '↑/↓: Navigate | Enter: Select | Esc: Cancel':
    '↑/↓: 导航 | Enter: 选择 | Esc: 取消',
  'Authenticate using TURBOSPARK OAuth': '使用 TURBOSPARK OAuth 进行认证',
  ...
  'Starting TURBOSPARK OAuth authentication...': '正在启动 TURBOSPARK OAuth 认证...',
  'Successfully authenticated with TURBOSPARK OAuth.': '已成功通过 TURBOSPARK OAuth 认证。',
  'Failed to authenticate with TURBOSPARK OAuth: {{error}}':
    'TURBOSPARK OAuth 认证失败：{{error}}',
  ...
  '  qwen auth turbospark-oauth     - Authenticate with TURBOSPARK OAuth (discontinued)':
    '  qwen auth turbospark-oauth     - 使用 TURBOSPARK OAuth 登录（已停用）',
  'Or simply run:': '或者直接运行：',
  '  qwen auth                - Interactive authentication setup\n':
    '  qwen auth                - 交互式认证配置\n',
  '✓ Authentication Method: TURBOSPARK OAuth': '✓ 认证方式：TURBOSPARK OAuth',
  ...
  'TURBOSPARK OAuth free tier was discontinued on 2026-04-15. Run /auth to switch to Coding Plan, OpenRouter, Fireworks AI, or another provider.':
    'TURBOSPARK OAuth 免费额度已于 2026-04-15 停用。请运行 /auth 切换到 Coding Plan、OpenRouter、Fireworks AI 或其他服务商。',
  ...
  "Set up TURBO SPARK's status line UI": '配置 TURBO SPARK 的状态栏',
  ...
  'Rollback on Windows requires manual intervention. Rename turbospark.old to turbospark in your installation directory.':
    '在 Windows 上回滚需要手动操作。请将安装目录中的 turbospark.old 重命名为 turbospark。',
