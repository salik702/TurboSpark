...
// Traditional Chinese (zh-TW) translations for TURBO SPARK CLI
...
export default {
  ...
  'for help on TURBO SPARK': '獲取 TURBO SPARK 幫助',
  ...
  'Analyzes the project and creates a tailored TURBOSPARK.md file.':
    '分析項目並創建定製的 TURBOSPARK.md 檔案',
  'List available TURBO SPARK tools. Usage: /tools [desc]':
    '列出可用的 TURBO SPARK 工具。用法：/tools [desc]',
  ...
  'Workspace is untrusted; workspace settings are ignored by the merged config. Run /trust first to persist skills changes here, or edit ~/.turbospark/settings.json directly to manage skills at user scope.':
    '目前工作區未受信任，工作區設定會被合併設定忽略。請先執行 /trust，或直接編輯 ~/.turbospark/settings.json 在使用者範圍管理技能。',
  ...
  'All available skills are disabled. Edit ~/.turbospark/settings.json or .turbospark/settings.json (skills.disabled) to re-enable.':
    '所有可用技能皆已停用。請編輯 ~/.turbospark/settings.json 或 .turbospark/settings.json（skills.disabled）以重新啟用。',
  ...
  Bundled: '內建',
  'Available TURBO SPARK CLI tools:': '可用的 TURBO SPARK CLI 工具：',
  ...
  'Are you sure you want to delete agent "{{name}}"?':
    '您確定要刪除智能體 "{{name}}" 嗎？',
  'Project Level (.turbospark/agents/)': '項目級 (.turbospark/agents/)',
  'User Level (~/.turbospark/agents/)': '用戶級 (~/.turbospark/agents/)',
  ...
  'Generate with TURBO SPARK (Recommended)': '使用 TURBO SPARK 生成（推薦）',
  ...
  'not updatable': '不可更新',
  error: '錯誤',
  'View and edit TURBO SPARK settings': '查看和編輯 TURBO SPARK 設置',
  Settings: '設置',
  'To see changes, TURBO SPARK must be restarted. Press r to exit and apply changes now.':
    '要查看更改，必須重啟 TURBO SPARK。按 r 退出並立即應用更改。',
  'Vim Mode': 'Vim 模式',
  ...
  'Respect .turbosparkignore': '遵守 .turbosparkignore',
  ...
  'This extension will append info to your TURBOSPARK.md context using {{fileName}}':
    '此擴展將使用 {{fileName}} 向您的 TURBOSPARK.md 上下文追加信息',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with TURBO SPARK.':
    '您正在安裝來自 {{originSource}} 的擴展。某些功能可能無法完美兼容 TURBO SPARK。',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run TURBO SPARK in one of these supported IDEs: VS Code or VS Code forks.':
    '您當前環境不支持 IDE 集成。要使用此功能，請在以下支持的 IDE 之一中運行 TURBO SPARK：VS Code 或 VS Code 分支版本。',
  ...
  'Manage TURBO SPARK hooks': '管理 TURBO SPARK Hook',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask TURBO SPARK.':
    '此選單為只讀。要添加或修改 Hook，請直接編輯 settings.json 或詢問 TURBO SPARK。',
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask TURBO SPARK.':
    '要重新啟用 Hook，請從 settings.json 中刪除 "disableAllHooks" 或詢問 TURBO SPARK。',
  Project: '項目',
  User: '用戶',
  Skill: '技能',
  System: '系統',
  ...
  'Right before TURBO SPARK concludes its response': 'TURBO SPARK 結束響應之前',
  ...
  'Generate a project summary and save it to .turbospark/PROJECT_SUMMARY.md':
    '生成項目摘要並保存到 .turbospark/PROJECT_SUMMARY.md',
  ...
  'Successfully added TURBOSPARK.md files from the following directories if there are:\n- {{directories}}':
    '如果存在，已成功從以下目錄添加 TURBOSPARK.md 檔案：\n- {{directories}}',
  ...
  'TURBOSPARK OAuth': 'TURBOSPARK OAuth (免費)',
  ...
  'TURBOSPARK OAuth free tier was discontinued on 2026-04-15. Please select Coding Plan or API Key instead.':
    'TURBOSPARK OAuth 免費額度已於 2026-04-15 停用。請選擇 Coding Plan 或 API Key。',
  'TURBOSPARK OAuth free tier was discontinued on 2026-04-15. Please select a model from another provider or run /auth to switch.':
    'TURBOSPARK OAuth免費層已於2026-04-15停止服務。請選擇其他提供商的模型或運行 /auth 切換。',
  '\n⚠ TURBOSPARK OAuth free tier was discontinued on 2026-04-15. Please select another option.\n':
    '\n⚠ TURBOSPARK OAuth 免費額度已於 2026-04-15 停用。請選擇其他選項。\n',
  ...
  'TURBOSPARK OAuth Authentication': 'TURBOSPARK OAuth 認證',
  'Please visit this URL to authorize:': '請訪問此 URL 進行授權：',
  'Waiting for authorization': '等待授權中',
  'Time remaining:': '剩餘時間：',
  'TURBOSPARK OAuth Authentication Timeout': 'TURBOSPARK OAuth 認證超時',
  'OAuth token expired (over {{seconds}} seconds). Please select authentication method again.':
    'OAuth token 已過期（超過 {{seconds}} 秒）。請重新選擇認證方法',
  'Press any key to return to authentication type selection.':
    '按任意鍵返回認證類型選擇',
  'Waiting for TURBOSPARK OAuth authentication...': '正在等待 TURBOSPARK OAuth 認證...',
  ...
  'Checked in at .turbospark/settings.json': '保存在 .turbospark/settings.json',
  'User settings': '用戶設置',
  'Saved in at ~/.turbospark/settings.json': '保存在 ~/.turbospark/settings.json',
  ...
  'You can run any shell commands from TURBO SPARK using ! (e.g. !ls).':
    '在 TURBO SPARK 中使用 ! 可運行任意 shell 命令（例如 !ls）。',
  ...
  'Add a TURBOSPARK.md file to give TURBO SPARK persistent project context.':
    '添加 TURBOSPARK.md 檔案，為 TURBO SPARK 提供持久的項目上下文。',
  ...
  'Agent powering down. Goodbye!': 'TURBO SPARK 正在關閉，再見！',
  ...
  '↑/↓: Navigate | Enter: Select | Esc: Cancel':
    '↑/↓: 導航 | Enter: 選擇 | Esc: 取消',
  'Authenticate using TURBOSPARK OAuth': '使用 TURBOSPARK OAuth 進行認證',
  ...
  'Starting TURBOSPARK OAuth authentication...': '正在啟動 TURBOSPARK OAuth 認證...',
  'Successfully authenticated with TURBOSPARK OAuth.': '已成功通過 TURBOSPARK OAuth 認證。',
  'Failed to authenticate with TURBOSPARK OAuth: {{error}}':
    'TURBOSPARK OAuth 認證失敗：{{error}}',
  ...
  '  qwen auth turbospark-oauth     - Authenticate with TURBOSPARK OAuth (discontinued)':
    '  qwen auth turbospark-oauth     - 使用 TURBOSPARK OAuth 登錄（已停用）',
  'Or simply run:': '或者直接運行：',
  '  qwen auth                - Interactive authentication setup\n':
    '  qwen auth                - 交互式認證配置\n',
  '✓ Authentication Method: TURBOSPARK OAuth': '✓ 認證方式：TURBOSPARK OAuth',
  ...
  'TURBOSPARK OAuth free tier was discontinued on 2026-04-15. Run /auth to switch to Coding Plan, OpenRouter, Fireworks AI, or another provider.':
    'TURBOSPARK OAuth 免費額度已於 2026-04-15 停用。請運行 /auth 切換到 Coding Plan、OpenRouter、Fireworks AI 或其他服務商。',
  ...
  "Set up TURBO SPARK's status line UI": '配置 TURBO SPARK 的狀態欄',
  ...
  'Rollback on Windows requires manual intervention. Rename turbospark.old to turbospark in your installation directory.':
    '在 Windows 上回滾需要手動操作。請將安裝目錄中的 turbospark.old 重新命名為 turbospark。',
