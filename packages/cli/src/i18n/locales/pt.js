...
// Portuguese translations for TURBO SPARK CLI (pt-BR)
...
export default {
  ...
  'for help on TURBO SPARK': 'para ajuda sobre o TURBO SPARK',
  ...
  'Analyzes the project and creates a tailored TURBOSPARK.md file.':
    'Analisa o projeto e cria um arquivo TURBOSPARK.md personalizado.',
  'List available TURBO SPARK tools. Usage: /tools [desc]':
    'Listar ferramentas TURBO SPARK disponíveis. Uso: /tools [desc]',
  ...
  'Workspace is untrusted; workspace settings are ignored by the merged config. Run /trust first to persist skills changes here, or edit ~/.turbospark/settings.json directly to manage skills at user scope.':
    'O espaço de trabalho não é confiável; as configurações do espaço de trabalho são ignoradas pela configuração combinada. Execute /trust primeiro, ou edite ~/.turbospark/settings.json diretamente para gerenciar habilidades no escopo do usuário.',
  ...
  'All available skills are disabled. Edit ~/.turbospark/settings.json or .turbospark/settings.json (skills.disabled) to re-enable.':
    'Todas as habilidades disponíveis estão desativadas. Edite ~/.turbospark/settings.json ou .turbospark/settings.json (skills.disabled) para reativá-las.',
  ...
  Bundled: 'Integrada',
  'Available TURBO SPARK CLI tools:': 'Ferramentas CLI do TURBO SPARK disponíveis:',
  ...
  'open full TURBO SPARK documentation in your browser':
    'abrir documentação completa do TURBO SPARK no seu navegador',
  ...
  // ============================================================================
  'Project Level (.turbospark/agents/)': 'Nível de Projeto (.turbospark/agents/)',
  'User Level (~/.turbospark/agents/)': 'Nível de Usuário (~/.turbospark/agents/)',
  ...
  'Generate with TURBO SPARK (Recommended)': 'Gerar com TURBO SPARK (Recomendado)',
  ...
  // ============================================================================
  'View and edit TURBO SPARK settings': 'Ver e editar configurações do TURBO SPARK',
  Settings: 'Configurações',
  'To see changes, TURBO SPARK must be restarted. Press r to exit and apply changes now.':
    'Para ver as alterações, o TURBO SPARK deve ser reiniciado. Pressione r para sair e aplicar as alterações agora.',
  // ============================================================================
  // Settings Labels
  // ============================================================================
  'Vim Mode': 'Modo Vim',
  ...
  'Respect .turbosparkignore': 'Respeitar .turbosparkignore',
  ...
  'This extension will append info to your TURBOSPARK.md context using {{fileName}}':
    'Esta extensão anexará informações ao seu contexto TURBOSPARK.md usando {{fileName}}',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with TURBO SPARK.':
    'Você está instalando uma extensão de {{originSource}}. Alguns recursos podem não funcionar perfeitamente com o TURBO SPARK.',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run TURBO SPARK in one of these supported IDEs: VS Code or VS Code forks.':
    'A integração com IDE não é suportada no seu ambiente atual. Para usar este recurso, execute o TURBO SPARK em um destes IDEs suportados: VS Code ou forks do VS Code.',
  ...
  // Commands - Hooks
  // ============================================================================
  'Manage TURBO SPARK hooks': 'Gerenciar hooks do TURBO SPARK',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask TURBO SPARK.':
    'Este menu é somente leitura. Para adicionar ou modificar hooks, edite settings.json diretamente ou pergunte ao TURBO SPARK.',
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask TURBO SPARK.':
    'Para reativar os hooks, remova "disableAllHooks" do settings.json ou pergunte ao TURBO SPARK.',
  // Hooks - Source
  Project: 'Projeto',
  User: 'Usuário',
  Skill: 'Habilidade',
  ...
  'Right before TURBO SPARK concludes its response':
    'Logo antes do TURBO SPARK concluir sua resposta',
  ...
  'Generate a project summary and save it to .turbospark/PROJECT_SUMMARY.md':
    'Gerar um resumo do projeto e salvá-lo em .turbospark/PROJECT_SUMMARY.md',
  ...
  'Successfully added TURBOSPARK.md files from the following directories if there are:\n- {{directories}}':
    'Arquivos TURBOSPARK.md adicionados com sucesso dos seguintes diretórios, se houverem:\n- {{directories}}',
  ...
  'TURBOSPARK OAuth free tier was discontinued on 2026-04-15. Please select Coding Plan or API Key instead.':
    'O nível gratuito do TURBOSPARK OAuth foi descontinuado em 2026-04-15. Selecione Coding Plan ou API Key.',
  'TURBOSPARK OAuth free tier was discontinued on 2026-04-15. Please select a model from another provider or run /auth to switch.':
    'O nível gratuito do TURBOSPARK OAuth foi descontinuado em 2026-04-15. Por favor, selecione um modelo de outro provedor ou execute /auth para trocar.',
  '\n⚠ TURBOSPARK OAuth free tier was discontinued on 2026-04-15. Please select another option.\n':
    '\n⚠ O nível gratuito do TURBOSPARK OAuth foi descontinuado em 2026-04-15. Selecione outra opção.\n',
  ...
  'TURBOSPARK OAuth Authentication': 'Autenticação TURBOSPARK OAuth',
  ...
  'TURBOSPARK OAuth Authentication Timeout':
    'Tempo Limite de Autenticação TURBOSPARK OAuth',
  ...
  'Waiting for TURBOSPARK OAuth authentication...':
    'Aguardando autenticação TURBOSPARK OAuth...',
  ...
  "TURBO SPARK won't ask before using allowed tools.":
    'O TURBO SPARK não perguntará antes de usar ferramentas permitidas.',
  'TURBO SPARK will ask before using these tools.':
    'O TURBO SPARK perguntará antes de usar essas ferramentas.',
  'TURBO SPARK is not allowed to use denied tools.':
    'O TURBO SPARK não tem permissão para usar ferramentas negadas.',
  ...
  'Checked in at .turbospark/settings.json': 'Registrado em .turbospark/settings.json',
  'User settings': 'Configurações do usuário',
  'Saved in at ~/.turbospark/settings.json': 'Salvo em ~/.turbospark/settings.json',
  ...
  'TURBO SPARK can read files in the workspace, and make edits when auto-accept edits is on.':
    'O TURBO SPARK pode ler arquivos na área de trabalho e fazer edições quando a aceitação automática está ativada.',
  'TURBO SPARK will be able to read files in this directory and make edits when auto-accept edits is on.':
    'O TURBO SPARK poderá ler arquivos neste diretório e fazer edições quando a aceitação automática está ativada.',
  ...
  'You can run any shell commands from TURBO SPARK using ! (e.g. !ls).':
    'Você pode executar quaisquer comandos shell do TURBO SPARK usando ! (ex: !ls).',
  ...
  'Add a TURBOSPARK.md file to give TURBO SPARK persistent project context.':
    'Adicione um arquivo TURBOSPARK.md para dar ao TURBO SPARK um contexto persistente do projeto.',
  ...
  '↑/↓: Navigate | Enter: Select | Esc: Cancel':
    '↑/↓: Navegar | Enter: Selecionar | Esc: Cancelar',
  'Authenticate using TURBOSPARK OAuth': 'Autenticar usando TURBOSPARK OAuth',
  ...
  'Starting TURBOSPARK OAuth authentication...':
    'Iniciando autenticação TURBOSPARK OAuth...',
  'Successfully authenticated with TURBOSPARK OAuth.':
    'Autenticado com sucesso via TURBOSPARK OAuth.',
  'Failed to authenticate with TURBOSPARK OAuth: {{error}}':
    'Falha ao autenticar com TURBOSPARK OAuth: {{error}}',
  ...
  '  qwen auth turbospark-oauth     - Authenticate with TURBOSPARK OAuth (discontinued)':
    '  qwen auth turbospark-oauth     - Autenticar com TURBOSPARK OAuth (descontinuado)',
  'Or simply run:': 'Ou simplesmente execute:',
  '  qwen auth                - Interactive authentication setup\n':
    '  qwen auth                - Configuração interativa de autenticação\n',
  '✓ Authentication Method: TURBOSPARK OAuth': '✓ Método de autenticação: TURBOSPARK OAuth',
  ...
  'TURBOSPARK OAuth free tier was discontinued on 2026-04-15. Run /auth to switch to Coding Plan, OpenRouter, Fireworks AI, or another provider.':
    'O nível gratuito do TURBOSPARK OAuth foi descontinuado em 2026-04-15. Execute /auth para mudar para Coding Plan, OpenRouter, Fireworks AI ou outro provedor.',
  ...
  "Set up TURBO SPARK's status line UI":
    'Configurar a interface da barra de status do TURBO SPARK',
