...
describe('earlyInputCapture', () => {
  ...
  beforeEach(() => {
    ...
    delete process.env['TURBOSPARK_DISABLE_EARLY_CAPTURE'];
  });
  ...
  describe('edge cases', () => {
    ...
    it('should skip when TURBOSPARK_DISABLE_EARLY_CAPTURE is set', () => {
      process.env['TURBOSPARK_DISABLE_EARLY_CAPTURE'] = '1';
      startEarlyInputCapture();
      mockStdin.write(Buffer.from('a'));
      stopEarlyInputCapture();
