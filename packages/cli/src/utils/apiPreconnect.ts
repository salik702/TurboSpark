...
const DEFAULT_BASE_URLS: Record<string, string> = {
  ...
  'turbospark-oauth': 'https://coding.dashscope.aliyuncs.com',
 ...
 *
 * @param authType - Authentication type (openai, turbospark-oauth, anthropic, etc.)
...
export function preconnectApi(
  ...
  // Check if disabled
  if (process.env['TURBOSPARK_DISABLE_PRECONNECT'] === '1') {
