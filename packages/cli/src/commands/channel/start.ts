...
import { normalizeProxyUrl, Storage } from '@turbospark/turbospark-core';
import { loadSettings } from '../../config/settings.js';
import { writeStderrLine, writeStdoutLine } from '../../utils/stdioHelpers.js';
import { AcpBridge, SessionRouter } from '@turbospark/channel-base';
import type {
  ChannelBase,
  ChannelPlugin,
  ToolCallEvent,
...
function sessionsPath(): string {
  return path.join(Storage.getGlobalTurbosparkDir(), 'channels', 'sessions.json');
}
 ...
 * Extensions declare channels in their turbospark-extension.json manifest.
 */
