...
export const REVIEW_TMP_DIR = join('.turbospark', 'tmp');
export const REVIEWS_DIR = join('.turbospark', 'reviews');
export const REVIEW_CACHE_DIR = join('.turbospark', 'review-cache');
 ...
 *
 * Files live under `.turbospark/tmp/` rather than the OS temp dir so the path is
