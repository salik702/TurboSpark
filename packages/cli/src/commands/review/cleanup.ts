...
//   - Remove the temporary worktree at .turbospark/tmp/review-pr-<n>.
//   - Delete the local branch ref qwen-review/pr-<n>.
//   - Remove any .turbospark/tmp/qwen-review-<target>-* side files.
//
...
function runCleanup(target: string): void {
  ...
  // --- Per-target side files (under .turbospark/tmp/) -------------------------
