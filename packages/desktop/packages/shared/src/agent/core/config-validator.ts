...
/**
 * TURBO SPARK specific config files that have known schemas.
 */
...
export class ConfigValidator {
  ...
  /**
   * Check if a file path is a TURBO SPARK config file.
   *
   * @param filePath - Path to check
   * @returns true if this is a TURBO SPARK config
   */
