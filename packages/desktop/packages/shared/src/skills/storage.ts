...
/** Global TURBO SPARK skills directory: ~/.turbospark/skills/ */
export const GLOBAL_QWEN_SKILLS_DIR = join(homedir(), '.turbospark', 'skills')

/** Project-level agent skills relative directory name */
export const PROJECT_AGENT_SKILLS_DIR = '.agents/skills'

/** Project-level TURBO SPARK skills relative directory name */
export const PROJECT_QWEN_SKILLS_DIR = '.turbospark/skills'
...
export function loadAllSkills(
  ...
  // 1. Global skills (lowest priority): ~/.turbospark/skills/ then ~/.agents/skills/
  ...
  // 3. Project skills (highest priority): {projectRoot}/.turbospark/skills/ then .agents/skills/
  if (projectRoot) {
