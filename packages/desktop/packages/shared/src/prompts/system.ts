...
/**
 * Get the TURBO SPARK environment marker for session detection.
 * This marker is embedded in the system prompt and allows us to identify
 * TURBO SPARK sessions in exported logs.
 */
...
- Global: \`~/.turbospark/skills/{slug}/SKILL.md\` or \`~/.agents/skills/{slug}/SKILL.md\`
- Workspace: \`${workspacePath}/skills/{slug}/SKILL.md\`
- Project: \`{projectRoot}/.turbospark/skills/{slug}/SKILL.md\` or \`{projectRoot}/.agents/skills/{slug}/SKILL.md\`
