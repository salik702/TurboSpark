#!/usr/bin/env bun
/**
 * Debug script to print the full TURBO SPARK system prompt with annotations.
...
printAnnotation('  2. TURBO SPARK Environment Marker - version, platform, arch');
...
${colors.bold}SDK Configuration:${colors.reset}
  systemPrompt.append: getSystemPrompt() ${colors.dim}// TURBO SPARK additions (static, cacheable)${colors.reset}
...
${colors.bold}Static System Prompt Components:${colors.reset}
  ...
  2. TURBO SPARK Environment Marker      ${colors.dim}// Version, platform, arch${colors.reset}
