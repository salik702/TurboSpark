#!/usr/bin/env bun
/**
 * Build script for standalone TURBO SPARK server.
 *
...
function showHelp(): void {
  console.log(`
Standalone server build script for TURBO SPARK
...
# TURBO SPARK Server — convenience entry point
...
[Unit]
Description=TURBO SPARK Server
...
async function main(): Promise<void> {
  ...
  console.log(`=== Building TURBO SPARK Server ${version} for ${platform}-${arch} ===`);
