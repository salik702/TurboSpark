...
This guide explains how to customize the visual theme of TURBO SPARK.

## Overview

TURBO SPARK uses a 6-color theme system with support for both app-level defaults and per-workspace overrides.
