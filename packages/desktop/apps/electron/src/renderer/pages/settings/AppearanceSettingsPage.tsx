...
import { TurbosparkPet } from '@/components/pet/TurbosparkPet'
...
export default function AppearanceSettingsPage() {
  ...
  useEffect(() => {
    window.electronAPI?.getHomeDir?.().then((home) =>
      setPetsFolder(`${home}/.turbospark/pets`),
    )
  }, [])
                ...
                <SettingsCard>
                      ...
                      label={
                        <div className="flex items-center gap-3">
                          <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-foreground/[0.04]">
                            <TurbosparkPet spritesheetUrl={pet.spritesheetUrl} state="idle" size={40} />
                          </div>
                  ...
                  {petEnabled && (
                    <SettingsRow
                      ...
                      description={petsFolder ?? '~/.turbospark/pets'}
                      action={
                        <div className="flex items-center gap-2">
                          <button
                            type="button"
