...
const MOCK_DATA: InsightData = {
  ...
  qualitative: {
    impressiveWorkflows: {
      intro:
        "You're a highly active TURBO SPARK user with 314 sessions over 67 days, achieving strong results in test creation, PR workflows, and debugging with a 68% success rate on clear tasks.",
    ...
    frictionPoints: {
      ...
      categories: [
        ...
        },
        {
          ...
          description:
            "You encountered buggy code generation in 5 instances where TURBO SPARK's initial implementations were incorrect, forcing you to spend additional time iterating on fixes before achieving working solutions.",
          examples: [
        ...
        },
        {
          ...
          description:
            "You experienced situations where TURBO SPARK's tools or skills failed to execute properly, forcing manual workarounds and excessive exploration that extended task completion time.",
          examples: [
    ...
    memorableMoment: {
      headline:
        "User paused mid-work to verify TURBO SPARK's corporate identity—\"Are you Alibaba's model or Zhipu's GLM?\"",
      detail:
      ...
      Qwen_md_additions: [
        {
          ...
          prompt_scaffold:
            'Create new ## Code Review Standards section in TURBOSPARK.md',
        },
        {
          addition:
          ...
          prompt_scaffold:
            'Create new ## Testing Conventions section in TURBOSPARK.md',
        },
        {
          addition:
          ...
          prompt_scaffold: 'Create new ## PR Workflow section in TURBOSPARK.md',
        },
      ],
      features_to_try: [
        {
        ...
        },
        {
          ...
          example_code:
            '# Create PR from latest commits\nturbospark -p "Create a PR for recent commits using .github/PULL_REQUEST_TEMPLATE.md"\n\n# Batch test generation\nturbospark -p "Generate tests for src/DataProcessor.ts"',
        },
        {
          feature: 'Task Agents',
          ...
          example_code:
            'Ask TURBO SPARK: "Use an agent to explore the test infrastructure and identify all test utilities available"',
        },
      ],
      usage_patterns: [
        {
        ...
        },
        {
          ...
          copyable_prompt:
            'Create .turbospark/skills/pr/SKILL.md with your PR template requirements, then just type /pr',
        },
        {
