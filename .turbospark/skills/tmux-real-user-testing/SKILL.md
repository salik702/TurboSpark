...
```bash
eval "$(bash .turbospark/skills/tmux-real-user-testing/scripts/tmux-real-user-log.sh \
...
```bash
bash .turbospark/skills/tmux-real-user-testing/scripts/tmux-real-user-log.sh help
```
