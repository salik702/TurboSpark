...
A short turbospark case to illustrate two failure modes from `SKILL.md`:
...
`~/.turbospark/logs` shows the model returned proper text. Stdout was empty.
...
Fix commit: turbospark `feadf052f` — `fix(cli): append newline to text-mode
